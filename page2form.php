...
<?php  if ($_POST['message']) {echo '<script type="text/javascript">alert("Form Submited Successfully");</script>';} ?>
...
<head>
	...
	<title>Job Application Page 2</title>
...
<li class="topNav"><a href="http://lesliestesting.com">Public Form</a></li>
</ul>
</td></tr></table>
<h1>Application for Employment</h1>

<a href="page1.php">Edit First Page</a> 
Welcome <?php echo $_SESSION["field5"]; ?><br>
Your email address is: <?php echo $_SESSION["field12"]; ?><br>
Position applying to is: <?php echo $_SESSION["field2"]; ?><br>
<?php echo $_SESSION["field46"]; ?><br>
<?php echo $_SESSION["field47"]; ?><br>
<?php echo $_SESSION["field48"]; ?><br>
<?php echo $_SESSION["field49"]; ?><br>
...
<tr><td style="text-align:right;"><label for="field89">Supervisor:</label>
  ...
  <textarea rows="5" cols="120" id ="field92" name ="field92" class="experience"></textarea>
		...
		<tr><td class="colorful"> </td><td class="colorful style="text-align:center">Name</td><td class="colorful style="text-align:center">Phone Number</td>
		<td class="colorful style="text-align:center">Best Time to Call</td><td class="colorful style="text-align:center">Occupation</td></tr>
		<tr><td class="colorful text-align:center"><label class="input required">1.</label></td>
		<td style="text-align:center"><input type="text" id="field93" name="field93" value=" " class="validate[required]"></td>
		<td style="text-align:center"><input type="tel" name="field94" id="field94" maxlength="25"class="validate[required]"></td>
		<td style="text-align:center"><input type="text" id="field95" name="field95" value=" " class="validate[required]"></td>
		<td style="text-align:center"><input type="text" id="field96" name="field96" value=" " class="validate[required]"></td>
		<tr><td class="colorful text-align:center"><label class="input required">2.</label></td>
		<td style="text-align:center"><input type="text" id="field97" name="field97" value=" " class="validate[required]"></td>
		<td style="text-align:center"><input type="tel" name="field98" id="field98" maxlength="25"class="validate[required]"></td>
		<td style="text-align:center"><input type="text" id="field99" name="field99" value=" " class="validate[required]"></td>
		<td style="border-right-color: #036; text-align:center">
		<input type="text" id="field100" name="field100" value=" " class="validate[required]"></td>
		<tr><td class="colorful text-align:center"><label class="input required">3.</label></td>
		<td style="text-align:center"><input type="text" id="field101" name="field101" value=" " class="validate[required]"></td>
		<td style="text-align:center"><input type="tel" name="field102" id="field102" maxlength="25"class="validate[required]"></td>
		<td style="border-bottom-color: #036; text-align:center">
		<input type="text" id="field103" name="field103" value=" " class="validate[required]"></td>
		<td style="border-bottom-color: #036; border-right-color: #036; text-align:center">
 ...
 <h2>APPLICANT'S STATEMENT</h2>
	...
	<br>
	<label for "captcha" class="required"><img src='capt.php'></label>&nbsp;<input type="text" name="captcha" id="captcha">
